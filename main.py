...
def main():
    ...
    train_dataset = datasets.MNIST(
        root="D:\medical_image_process\data", train=True, transform=transform, download=True
    )
    test_dataset = datasets.MNIST(
        root="D:\medical_image_process\data", train=False, transform=transform, download=True
    )
    # 数据加载器
